...
public class TC_MyAccountPageTest extends BaseClass {
	...
	public void verifyRegistrationAndLogin()
	{
		...
		accCreationPg.enterCustomerFirstName("Nikita");
		accCreationPg.enterCustomerLastName("Nikita");
		accCreationPg.enterPassword("cs923");
		accCreationPg.enterAddressFirstName("Nikita");
		accCreationPg.enterAddressLastName("Jadhav");
		...
		Assert.assertEquals("Nikita Jadhav", userName);
	...
	public void VerifyLogin() throws IOException 
	{
		...
		if(userName.equals("Nikita Jadhav"))
		{
